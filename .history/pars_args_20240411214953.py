...
parser.add_argument('--n_epochs',       type=int,   default=100)##TODO!!!，先只取3，原来为300

parser.add_argument('--batch_size',     type=int,   default=256)##TODO!!!，先只取8，原来为256
...
parser.add_argument('--seq_len',     type=int,   default=256)##TODO!!!,先只取一部分长度，截断，应该为682
