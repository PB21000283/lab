...
parser.add_argument('--n_epochs',       type=int,   default=200)##TODO!!!，先只取3，原来为300

parser.add_argument('--batch_size',     type=int,   default=128)##TODO!!!，先只取8，原来为256
...
parser.add_argument('--max_epoch',     type=int,   default=20)##transformer层数
...
parser.add_argument('--seq_len',     type=int,   default=64)##TODO!!!,先只取一部分长度，截断，应该为682
