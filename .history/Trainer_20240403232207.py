...
class Trainer:
    ...
    def _pass(self, data, train=True):
        ...
        poi_pos, poi_neg,X, targets, target_masks, padding_masks = data##TODO data中加上masking
        ...
        last_output_y_emb, pos_poi_emb, traj_poi_emb_pos = self.model((batch_y, batch_y_len, #正样本
                                                                       poi_pos,
                                                                       batch_traj_poi_pos,
                                                                       ), False)
        ...
        ##TODO
        predictions_l, _, _ = self.model(batch_x, batch_x_len, X,#mask
