...
def _cal_loss(self, pred, targets, targets_mask):##轨迹掩码恢复
    batch_loss_list = torch.nn.NLLLoss(ignore_index=0, reduction='none', pred.transpose(1, 2), targets)
...
class Trainer:
    ...
    def _pass(self, data, train=True):
        ...
        poi_pos, poi_neg,X, targets, target_masks, padding_masks,masks_len = data##TODO data中加上masking
        ...
        ##TODO
        predictions_l = self.model(batch_x, batch_x_len, X,#前向传播
