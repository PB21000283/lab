...
from Data_Loader import TrainValueDataLoader, ValValueDataLoader
...
def train():
    ...
    val_data_loader = ValValueDataLoader(  #加载所有数据
        args.val_file,  args.batch_size)

    model =  JHL_Model(args, device, batch_first=True)
